...
execute_process(
  COMMAND "/usr/bin/git" show-ref v2.1.4
  WORKING_DIRECTORY "/home/gentoo/afni/src/gifti/nifti_clib_download"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.1.4")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.1.4")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v2.1.4
  WORKING_DIRECTORY "/home/gentoo/afni/src/gifti/nifti_clib_download"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/leej3/nifti_clib.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/gentoo/afni/src/gifti/nifti_clib_download/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/gentoo/afni/src/gifti/nifti_clib_download/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout v2.1.4
      WORKING_DIRECTORY "/home/gentoo/afni/src/gifti/nifti_clib_download"
      RESULT_VARIABLE error_code
      )
    if(error_code)
